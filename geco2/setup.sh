...
uv venv --python 3.10
uv pip install torchvision==0.26.0 torchaudio==2.11.0 numpy==1.26.4 pillow==10.4.0 opencv-python-headless matplotlib scipy scikit-image pycocotools https://github.com/vicoslab/toolbox-models/releases/download/v0.1.8/multiscaledeformableattention-1.0-cp310-cp310-linux_x86_64.whl tqdm einops==0.8.1 hydra-core==1.3.2 omegaconf==2.3.0 pandas==2.2.3 imageio==2.37.0
