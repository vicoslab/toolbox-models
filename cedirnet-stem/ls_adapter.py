...
def export(annotations, export_dir, relpaths, shared):
    ...
    # Empty submitted legacy annotation is a confirmed particle negative. A task
    # with no annotation never calls this adapter and therefore remains missing.
    if points or 'Nanoparticles' in reviewed or not tags:
