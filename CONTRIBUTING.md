...
### Registry
Model import strings are base64 encoded json. Easiest way to read/write one is in the browser console:
```bash
btoa(JSON.stringify([{ owner: "ViCoS", group: "Tracking", models: ["dam4sam"], url: "https://github.com/vicoslab/toolbox-models"}]))
> W3sib3duZXIiOiJWaUNvUyIsImdyb3VwIjoiVHJhY2tpbmciLCJtb2RlbHMiOlsiZGFtNHNhbSJdLCJ1cmwiOiJodHRwczovL2dpdGh1Yi5jb20vdmljb3NsYWIvdG9vbGJveC1tb2RlbHMifV0=
